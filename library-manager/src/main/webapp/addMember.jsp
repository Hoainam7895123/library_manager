		...
		<section class="section dashboard">
			<div class="row">
        		...
        		<script type="text/javascript">
            		...
            		window.location.href = 'listMember.jsp';
        		</script>
        		<%
            		}
        		%>
						...
						<form class="row g-3"
							...
							<div class="col-12">
								<label for="input_id" class="form-label">ID</label> <input
									type="text" class="form-control" id="input_id" name="memberID">
							</div>
							<div class="col-12">
								<label for="input_name" class="form-label">Tên thành viên</label> <input
									type="text" class="form-control" id="input_name" name="name">
							</div>
							<div class="col-12">
								<label for="input_address" class="form-label">Địa chỉ</label> <input
									type="text" class="form-control" id="input_address"
									name="address">
							</div>
							<div class="col-12">
								<label for="input_phone" class="form-label">Số điện thoại</label> <input
									type="text" class="form-control" id="input_phone" name="phone">
							</div>
							<div class="col-12">
								<label for="input_email" class="form-label">Email</label> <input type="email" class="form-control"
