...
<%@page import="member.memberModel.*"%>
					...
					<div class="card-body">
						...
						<form class="row g-3"
							...
							<div class="col-12 pt-3">
								...
								<input type="text" class="form-control" id="input_name" name="name" value="${member.member_name}">
							</div>
							<div class="col-12">
								<label for="input_address" class="form-label">Địa chỉ</label> <input
									type="text" class="form-control" id="input_address" name="address" value="${member.member_address}">
							</div>
							<div class="col-12">
							...
							<div class="col-12">
								<label for="input_email" class="form-label">Email</label> <input
									type="text" class="form-control" id="input_email" name="email" value="${member.member_email}">
							</div>
