...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link " href="${pageContext.request.contextPath}/books">
					<i class="bi bi-grid"></i> <span>Danh sách sách</span>
			</a></li>
			<!-- End Dashboard Nav -->

			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-menu-button-wide"></i><span>Quản lý sách</span><i
					...
					<div class="card-body">
						...
						<form class="row g-3"
							...
							<div class="col-12 pt-3">
								...
								<input type="text" class="form-control" id="input_category" name="category">
							</div>
							<div class="col-12">
